...
class SelectExerciseTableViewController: UITableViewController {
    ...
    let exercises = ["Standing Dumbell Curls", "Standing Band Curls", "Seated Curls", "Standing Barbell Curls"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("SelectExerciseCellIdentifier", forIndexPath: indexPath)
